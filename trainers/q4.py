...
from utils import create_data_loaders, plot_train_test_loss, plot_train_test_accuracy, get_small_train_dataloader
...
def main():
    ...
    trainloader = get_small_train_dataloader(TRAIN_BATCH_SIZE)
    ...
    torch.save(classifier_model.state_dict(), 'weights/q4/classifier.pth')
